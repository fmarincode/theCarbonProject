      ...
      {!inscriptionComponent ? (
        <>
          <p className="text-[#242422] text-justify px-5 md:pr-10 md:pl-10 font-bold text-lg drop-shadow-lg">
            ...
            très bien son boulot. Maintenant que tu es là, grâce à l'API de
            Carbon Interface, tu vas pouvoir calculer le poids du rejet en CO2
            de tes déplacements en avion. Mais avant ça, un peu de latin :
            Provident culpa deserunt quibusdam nostrum accusamus enim vitae.
            Repellat sapiente libero necessitatibus non rem accusamus ad esse
            ullam maxime blanditiis cupiditate ab harum praesentium!
          </p>
          <div>
            <button
              type="button"
              className="rounded-full font-bold pt-3 pb-3 pl-6 pr-6 bg-[#6C8C26] w-28 mt-5 mb-5 md:w-32 md:relative md:bottom-14"
