      ...
      {!inscriptionComponent ? (
        <>
          <p className="text-[#242422] text-justify px-5 md:pr-10 md:pl-10 font-bold text-lg drop-shadow-lg">
            ...
            , tu vas pouvoir calculer le poids du rejet en CO2 de tes
            déplacements en avion. Mais avant ça, un peu de latin : Provident
            culpa deserunt quibusdam nostrum accusamus enim vitae. Repellat
            sapiente libero necessitatibus non rem accusamus ad esse ullam
            maxime blanditiis cupiditate ab harum praesentium!
          </p>
          <div>
            <button
              type="button"
